...
import nodeHelper from 'src/Graph/components/node/node.helper';
import CONST from 'src/Graph/components/node/node.const';
import { logWarning } from 'src/Graph/utils';
...
export default class Node extends React.Component {
    ...
    handleOnRightClickNode = (event) =>
        this.props.onRightClickNode && this.props.onRightClickNode(event, this.props.id);
