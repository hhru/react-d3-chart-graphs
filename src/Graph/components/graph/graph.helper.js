...
import { isDeepEqual, isEmptyObject, merge, pick, antiPick, throwErr, logWarning } from 'src/Graph/utils';
...
function getNormalizedNodeCoordinates(
    ...
    switch (targetSymbolType) {
        case CONST.SYMBOLS.CIRCLE: {
            ...
            const strokeSize = strokeWidth * Math.min(config.link?.markerWidth || 0, config.link?.markerHeight || 0);
